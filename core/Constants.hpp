...
namespace hlt {
    constexpr auto MAX_PLAYERS = 4; //4
    ...
    struct GameConstants {
        ...
        unsigned short DOCKED_SHIP_REGENERATION = 10; //0

        unsigned int WEAPON_COOLDOWN = 1; //1
        double WEAPON_RADIUS = 5.0; //5.0
        int WEAPON_DAMAGE = 50; //64
        double EXPLOSION_RADIUS = 40.0; //10.0

        double DOCK_RADIUS = 4.5; //4.0
        unsigned int DOCK_TURNS = 3; //5
        int RESOURCES_PER_RADIUS = 180; //144
        bool INFINITE_RESOURCES = false; //true
        int PRODUCTION_PER_SHIP = 90; //72
        unsigned int BASE_PRODUCTIVITY = 7; //6
        unsigned int ADDITIONAL_PRODUCTIVITY = 7; //6

        int SPAWN_RADIUS = 4; //2
